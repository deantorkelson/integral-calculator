...
public class Calculator
{
    ...
    public double[] createFunction() {
    	...
    	System.out.println("How many terms are in the function you want to integrate?");
   		...
   		//creates the array of coefficients. The index of each element is its corresponding power of x
    ...
    public double integrate(double[] bounds, double[] coefs) {
    	...
    	double y2 = 0;
    	double area = 0;
    	//distance x must increment each time to have the appropriate number of trapezoids
